...
public class AboutDialog extends JDialog {
	...
	public AboutDialog() {
		...
		HTMLUtils.appendLineBreak(sb);
		HTMLUtils.appendLine(sb, "ISC License");
		HTMLUtils.appendLineBreak(sb);
		...
		HTMLUtils.appendLine(sb, "See subfolder \"vendor\" for a list of third-party software products and media assets that are redistributed and/or used in accordance to their respective license.");

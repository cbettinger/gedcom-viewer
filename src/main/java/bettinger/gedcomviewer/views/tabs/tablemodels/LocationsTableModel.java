...
public class LocationsTableModel extends TableModel<Location> {
	...
	public LocationsTableModel(final GEDCOM gedcom, final String searchQuery) {
		super(new String[] { I18N.get("No"), I18N.get("Name"), I18N.get("Latitude"), I18N.get("Longitude"), Structure.SUPER_SIGN, Structure.SUB_SIGN, I18N.get("Media"), I18N.get("Notes"), I18N.get("References"), I18N.get("LastChange") }, gedcom.getLocations(searchQuery));
	}
	...
	public Object getValueAt(final int row, final int col) {
		...
		return switch (col) {
			...
			case 4 -> location.getSuperordinateLocations().size();
			case 5 -> location.getSubordinateLocations().size();
			case 6 -> location.getMedia().size();
			case 7 -> location.getNotes().size();
			case 8 -> location.getReferences().size();
			case 9 -> location.getLastChange();
			default -> "";
		};
	}

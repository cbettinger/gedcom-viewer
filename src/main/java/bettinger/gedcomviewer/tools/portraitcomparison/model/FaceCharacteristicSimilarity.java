...
public class FaceCharacteristicSimilarity {
    ...
    public FaceCharacteristicSimilarity(float maxSimilarity, float avgSimilarity, Image targetPersonImage, Image otherPersonImage) {

...
class Eyes(TwoElementalFacePart):
    ...
    def __init__(self, faceLandmarks):
        super().__init__("Augen", faceLandmarks, "rechtes Auge", "linkes Auge", Eyes.rightEyeLidsIndices, Eyes.leftEyeLidsIndices, 133, 362, 230, 450, None, None, classifier1=XGB_CLASSIFIERS["EYESHAPE"]["first"], classifier2=XGB_CLASSIFIERS["EYESHAPE"]["second"])
